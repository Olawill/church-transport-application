                        ...
                        <Select
                          ...
                          onValueChange={(value) => {
                            ...
                            if (
                              ...
                              // Calculate next date for this specific day
                              const daysOfWeek = selectedService?.weekdays.map(
                                (w) => w.dayOfWeek
                              );
                              ...
                              const endDate =
                                selectedService.endDate ?? undefined;
                              ...
                              const occurrences = getNextOccurrencesOfWeekdays({
                                ...
                                ordinal: selectedService.ordinal,
                              });
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between pb-3">
                          <div className="space-y-0.5">
                            ...
                            <FormDescription>
                              Will you like to make a multiple request for this
                              service? Service Date must be a valid date to
                              enable recurring ride requests.
                            </FormDescription>
                          </div>
                          <FormControl>
                            <Switch
